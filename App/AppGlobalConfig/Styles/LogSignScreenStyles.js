...
class LogSignScreenStyles {
    loadStyles = () => {
      ...
      GLOBAL.topTabsStyle = StyleSheet.create({
        topTabButtonOn: {
          height: topTabButtonHeight, width: (width / 2) - 16, backgroundColor: topTabColorOn,
        },
        topTabButtonOff: {
          height: topTabButtonHeight, width: (width / 2) - 16, backgroundColor: topTabColorOff
        },
        view: {
          flexDirection: 'row',
        },
