const SERVER = 'http://192.168.1.8:3000';
...
const config = {
    urls: {
        ...
        get_all_friends: `${API}/api/friend/get_all_friends`,
        ...
        go_online:`${API}/auth/go_online`,
        forget_password:`${API}/auth/forget_password`,
        change_password:`${API}/auth/change_password`,
        check_code:`${API}/auth/check_code`,
        get_conversations:`${API}/api/message/get_conversations`,
    }
}
